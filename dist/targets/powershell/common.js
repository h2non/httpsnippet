...
var generatePowershellConvert = function (command) {
    var convert = function (_a) {
        ...
        if (postData.text) {
            var type = (0, headers_1.getHeader)(allHeaders, 'content-type') || postData.mimeType || '';
            commandOptions.push("-ContentType '".concat((0, escape_1.escapeString)(type, { delimiter: "'", escapeChar: '`' }), "'"));
